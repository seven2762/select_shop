...
import com.sparta.myselectshop.product.repository.ProductFolderRepository;
...
public class ProductService  {
    ...
    public List<ProductResponseDto> getProducts(com.sparta.myselectshop.user.entity.User user) {
